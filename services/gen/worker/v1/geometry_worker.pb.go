...
type InspectExchangeRequest struct {
	...
	// When set, parse once and materialize one local BREP per unique Part Definition under this opaque key prefix.
...
// Temporary exchange graph; identities refer to source definitions, not hashes.
type ExchangeOccurrence struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
...
func (x *ExchangeOccurrence) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ExchangeOccurrence) GetDefinitionId() string {
	if x != nil {
...
func (x *ExchangeOccurrence) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ExchangeOccurrence) GetTranslation() *Vec3 {
	if x != nil {
		return x.Translation
	}
	return nil
...
func (x *ExchangeOccurrence) GetRotation() *Quaternion {
	if x != nil {
		return x.Rotation
	}
	return nil
...
func (x *ExchangeDefinition) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ExchangeDefinition) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ExchangeDefinition) GetKind() string {
	if x != nil {
		return x.Kind
	}
	return ""
...
func (x *ExchangeDefinition) GetBrep() *ArtifactReference {
	if x != nil {
		return x.Brep
	}
	return nil
...
type ExchangeGraph struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Definitions   []*ExchangeDefinition  `protobuf:"bytes,1,rep,name=definitions,proto3" json:"definitions,omitempty"`
	Roots         []*ExchangeOccurrence  `protobuf:"bytes,2,rep,name=roots,proto3" json:"roots,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ExchangeGraph) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ExchangeGraph) GetRoots() []*ExchangeOccurrence {
	if x != nil {
		return x.Roots
	}
	return nil
...
type InspectExchangeResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Graph         *ExchangeGraph         `protobuf:"bytes,1,opt,name=graph,proto3" json:"graph,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ImportExchangeRequest struct {
	...
	DefinitionId      string                 `protobuf:"bytes,5,opt,name=definition_id,json=definitionId,proto3" json:"definition_id,omitempty"` // STEP source label identity; empty only for a single Part graph.
...
func (x *ImportExchangeRequest) GetDefinitionId() string {
	if x != nil {
		return x.DefinitionId
	}
	return ""
...
type ExportExchangeRequest struct {
	...
	RequestId     string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	Format        string                 `protobuf:"bytes,2,opt,name=format,proto3" json:"format,omitempty"` // STEP | BREP
	Graph         *ExchangeGraph         `protobuf:"bytes,3,opt,name=graph,proto3" json:"graph,omitempty"`
...
func (x *ExportExchangeRequest) GetGraph() *ExchangeGraph {
	if x != nil {
		return x.Graph
	}
	return nil
...
const file_occccad_worker_v1_geometry_worker_proto_rawDesc = "" +
	...
	"\x17component_output_prefix\x18\x04 \x01(\tR\x15componentOutputPrefix\"\xd3\x01\n" +
	"\x12ExchangeOccurrence\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12#\n" +
	...
	"\x17InspectExchangeResponse\x126\n" +
	"\x05graph\x18\x01 \x01(\v2 .occccad.worker.v1.ExchangeGraphR\x05graph\"\xfe\x02\n" +
	...
	"\x12angular_deflection\x18\t \x01(\x01R\x11angularDeflection\"\xa5\x01\n" +
	"\x15ExportExchangeRequest\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x16\n" +
	"\x06format\x18\x02 \x01(\tR\x06format\x126\n" +
	"\x05graph\x18\x03 \x01(\v2 .occccad.worker.v1.ExchangeGraphR\x05graph\x12\x1d\n" +
	"\n" +
