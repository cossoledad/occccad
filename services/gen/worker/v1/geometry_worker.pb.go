...
var file_occccad_worker_v1_geometry_worker_proto_depIdxs = []int32{
	...
	0,  // 28: occccad.worker.v1.ProfilePadSpec.axis_start:type_name -> occccad.worker.v1.Vec2
	0,  // 29: occccad.worker.v1.ProfilePadSpec.axis_end:type_name -> occccad.worker.v1.Vec2
	50, // 30: occccad.worker.v1.ProfilePadSpec.plane_origin:type_name -> occccad.worker.v1.Vec3
	50, // 31: occccad.worker.v1.ProfilePadSpec.plane_normal:type_name -> occccad.worker.v1.Vec3
	50, // 32: occccad.worker.v1.ProfilePadSpec.plane_u_direction:type_name -> occccad.worker.v1.Vec3
	16, // 33: occccad.worker.v1.InspectExchangeRequest.source:type_name -> occccad.worker.v1.ArtifactReference
	18, // 34: occccad.worker.v1.InspectExchangeResponse.components:type_name -> occccad.worker.v1.ExchangeComponentInfo
	16, // 35: occccad.worker.v1.ImportExchangeRequest.source:type_name -> occccad.worker.v1.ArtifactReference
	16, // 36: occccad.worker.v1.ExchangeComponent.brep:type_name -> occccad.worker.v1.ArtifactReference
	50, // 37: occccad.worker.v1.ExchangeComponent.translation:type_name -> occccad.worker.v1.Vec3
	21, // 38: occccad.worker.v1.ExportExchangeRequest.components:type_name -> occccad.worker.v1.ExchangeComponent
	16, // 39: occccad.worker.v1.ExportExchangeResponse.result:type_name -> occccad.worker.v1.ArtifactReference
	26, // 40: occccad.worker.v1.EvaluatePartResponse.mesh:type_name -> occccad.worker.v1.Mesh
	49, // 41: occccad.worker.v1.EvaluatePartResponse.bbox:type_name -> occccad.worker.v1.BoundingBox
	30, // 42: occccad.worker.v1.EvaluatePartResponse.topology:type_name -> occccad.worker.v1.TopologySummary
	16, // 43: occccad.worker.v1.EvaluatePartResponse.brep_artifact:type_name -> occccad.worker.v1.ArtifactReference
	16, // 44: occccad.worker.v1.EvaluatePartResponse.glb_artifact:type_name -> occccad.worker.v1.ArtifactReference
	50, // 45: occccad.worker.v1.Mesh.vertices:type_name -> occccad.worker.v1.Vec3
	29, // 46: occccad.worker.v1.Mesh.triangles:type_name -> occccad.worker.v1.Triangle
	27, // 47: occccad.worker.v1.Mesh.edges:type_name -> occccad.worker.v1.EdgePolyline
	28, // 48: occccad.worker.v1.Mesh.topology_vertices:type_name -> occccad.worker.v1.TopologyPoint
	50, // 49: occccad.worker.v1.EdgePolyline.points:type_name -> occccad.worker.v1.Vec3
	50, // 50: occccad.worker.v1.TopologyPoint.point:type_name -> occccad.worker.v1.Vec3
	49, // 51: occccad.worker.v1.LoadGeometryResponse.bbox:type_name -> occccad.worker.v1.BoundingBox
	16, // 52: occccad.worker.v1.GetTopologyRequest.brep_artifact:type_name -> occccad.worker.v1.ArtifactReference
	40, // 53: occccad.worker.v1.GetTopologyResponse.faces:type_name -> occccad.worker.v1.FaceInfo
	41, // 54: occccad.worker.v1.GetTopologyResponse.edges:type_name -> occccad.worker.v1.EdgeInfo
	42, // 55: occccad.worker.v1.GetTopologyResponse.vertices:type_name -> occccad.worker.v1.VertexInfo
	50, // 56: occccad.worker.v1.TopologyProperty.vector_value:type_name -> occccad.worker.v1.Vec3
	49, // 57: occccad.worker.v1.FaceInfo.bbox:type_name -> occccad.worker.v1.BoundingBox
	39, // 58: occccad.worker.v1.FaceInfo.properties:type_name -> occccad.worker.v1.TopologyProperty
	49, // 59: occccad.worker.v1.EdgeInfo.bbox:type_name -> occccad.worker.v1.BoundingBox
	39, // 60: occccad.worker.v1.EdgeInfo.properties:type_name -> occccad.worker.v1.TopologyProperty
	50, // 61: occccad.worker.v1.EdgeInfo.render_points:type_name -> occccad.worker.v1.Vec3
	50, // 62: occccad.worker.v1.VertexInfo.point:type_name -> occccad.worker.v1.Vec3
	39, // 63: occccad.worker.v1.VertexInfo.properties:type_name -> occccad.worker.v1.TopologyProperty
	31, // 64: occccad.worker.v1.GeometryWorker.Ping:input_type -> occccad.worker.v1.PingRequest
	11, // 65: occccad.worker.v1.GeometryWorker.EvaluatePart:input_type -> occccad.worker.v1.EvaluatePartRequest
	9,  // 66: occccad.worker.v1.GeometryWorker.SolveSketch:input_type -> occccad.worker.v1.SolveSketchRequest
	17, // 67: occccad.worker.v1.GeometryWorker.InspectExchange:input_type -> occccad.worker.v1.InspectExchangeRequest
	20, // 68: occccad.worker.v1.GeometryWorker.ImportExchange:input_type -> occccad.worker.v1.ImportExchangeRequest
	22, // 69: occccad.worker.v1.GeometryWorker.ExportExchange:input_type -> occccad.worker.v1.ExportExchangeRequest
	33, // 70: occccad.worker.v1.GeometryWorker.LoadGeometry:input_type -> occccad.worker.v1.LoadGeometryRequest
	35, // 71: occccad.worker.v1.GeometryWorker.UnloadGeometry:input_type -> occccad.worker.v1.UnloadGeometryRequest
	37, // 72: occccad.worker.v1.GeometryWorker.GetTopology:input_type -> occccad.worker.v1.GetTopologyRequest
	43, // 73: occccad.worker.v1.GeometryWorker.Tessellate:input_type -> occccad.worker.v1.TessellateRequest
	45, // 74: occccad.worker.v1.GeometryWorker.CreateChamfer:input_type -> occccad.worker.v1.CreateChamferRequest
	47, // 75: occccad.worker.v1.GeometryWorker.CreateFillet:input_type -> occccad.worker.v1.CreateFilletRequest
	32, // 76: occccad.worker.v1.GeometryWorker.Ping:output_type -> occccad.worker.v1.PingResponse
	25, // 77: occccad.worker.v1.GeometryWorker.EvaluatePart:output_type -> occccad.worker.v1.EvaluatePartResponse
	10, // 78: occccad.worker.v1.GeometryWorker.SolveSketch:output_type -> occccad.worker.v1.SolveSketchResponse
	19, // 79: occccad.worker.v1.GeometryWorker.InspectExchange:output_type -> occccad.worker.v1.InspectExchangeResponse
	25, // 80: occccad.worker.v1.GeometryWorker.ImportExchange:output_type -> occccad.worker.v1.EvaluatePartResponse
	23, // 81: occccad.worker.v1.GeometryWorker.ExportExchange:output_type -> occccad.worker.v1.ExportExchangeResponse
	34, // 82: occccad.worker.v1.GeometryWorker.LoadGeometry:output_type -> occccad.worker.v1.LoadGeometryResponse
	36, // 83: occccad.worker.v1.GeometryWorker.UnloadGeometry:output_type -> occccad.worker.v1.UnloadGeometryResponse
	38, // 84: occccad.worker.v1.GeometryWorker.GetTopology:output_type -> occccad.worker.v1.GetTopologyResponse
	44, // 85: occccad.worker.v1.GeometryWorker.Tessellate:output_type -> occccad.worker.v1.TessellateResponse
	46, // 86: occccad.worker.v1.GeometryWorker.CreateChamfer:output_type -> occccad.worker.v1.CreateChamferResponse
	48, // 87: occccad.worker.v1.GeometryWorker.CreateFillet:output_type -> occccad.worker.v1.CreateFilletResponse
