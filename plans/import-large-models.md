...
> 状态：待实施。IMPORT-DIAGNOSTICS 与 IMPORT-NAMING 已完成并移出待办，事实与验证见[诊断](../docs/architecture/current/jobs-artifacts.md#import-diagnostics-完成记录2026-09-22)与[导入命名](../docs/architecture/current/persistent-naming.md#导入根命名import-naming-已完成2026-09-22)；其余任务待实施，尚未进行大文件验收。返回[统一路线](README.md)；唯一详细设计见[大文件导入与大模型工作集](../docs/architecture/target/large-models.md)，不在计划复制一套架构。
